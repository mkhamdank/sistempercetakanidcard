	        ...
	        <!-- sidebar menu end-->
					...
					<section id="main-content">
				      <section class="wrapper">
				        <h3 class="fontstyle"><b>Data User</b></h3>
				        <div class="row mb">
				          <!-- page start-->
				          <div class="content-panel col-md-12">
				            <div class="adv-table">
				            	<a class="btn btn-theme03 fontstyle" href="<?php echo site_url('User/create') ?>">Tambah User</a>
				            	<br>
				            	<br>
				              ...
				              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="example">
								...
								<?php foreach($user as $key){ ?>
									<tr>
										...
										<td>
										      <a href="<?=site_url()?>/User/update/<?php echo $key->id_login ?>"><button class="btn btn-primary" data-title="Edit" data-toggle="modal" data-target="#edit"><span class="glypchon glypchon-pencil">Edit</span></button></a>
										      <a class="btn btn-danger"  href="<?php echo site_url('User/delete/'.$key->id_login) ?>" OnClick="return confirmDialog()">Delete</a>
										</td>
									</tr>
								<?php } ?>
								 </tbody>
