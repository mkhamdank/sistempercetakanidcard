	...
	<body>
	    ...
	    <section id="main-content">
	      <section class="wrapper">
	      	 <h3 class="fontstyle">Tambah Data User</h3>
	        <div class="row mt">
	          <div class="col-lg-12">
	              	...
	              	<?php echo validation_errors(); ?>
		                ...
		                <div class="form-group">
		                  <label for="" class="col-sm-2 col-sm-2 control-label">Nama</label>
							<div class="col-md-3 col-xs-11">
								<input type="text" class= "form-control" name="nama" class="form-control" placeholder="Masukkan Nama" required>
							</div>
		                </div>
		                <div class="form-group">
			                 <label for="" class="col-sm-2 col-sm-2 control-label">Seksi</label>
								<div class="col-md-3 col-xs-11">
									<input type="text" class="form-control" name="seksi" placeholder="Masukkan Seksi" required>
								</div>
		                </div>
		                <div class="form-group">
