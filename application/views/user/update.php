	...
	<body>
	    ...
	    <section id="main-content">
	      <section class="wrapper">
	      	<h4 class="mb fontstyle">Edit Data User</h4>
	        <div class="row mt">
	          <div class="col-lg-12">
	            <div class="form-panel">
	              	...
	              	<?php echo form_open_multipart('User/update/'.$this->uri->segment(3),$attributes); ?>
	              	<?php echo validation_errors(); ?>
	              	<?php foreach ($user as $key) { ?>
		                <div class="form-group">
		                 <label for="" class="col-sm-2 col-sm-2 control-label">Username</label>
							<div class="col-md-3 col-xs-11">
								<input type="text" class="form-control" name="username" placeholder="Masukkan Username" value="<?php echo $key->username ?>" required>
							</div>
		                </div>
		                <div class="form-group">
		                  <label for="" class="col-sm-2 col-sm-2 control-label">Password</label>
							 <div class="col-md-3 col-xs-11">
								<input type="password" class="form-control" name="password" placeholder="Masukkan Password Lagi" required>
							 </div> 
		                  </div>
		                <div class="form-group">
		                  <label for="" class="col-sm-2 col-sm-2 control-label">Nama</label>
							<div class="col-md-3 col-xs-11">
							<input type="text" class= "form-control" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?php echo $key->nama ?>" required>
							</div>
		                </div>
		                <div class="form-group">
			                 <label for="" class="col-sm-2 col-sm-2 control-label">Seksi</label>
							<div class="col-md-3 col-xs-11">
							<input type="text" class="form-control" name="seksi" placeholder="Masukkan Seksi" value="<?php echo $key->seksi ?>" required>
							</div>
		                </div>
		                <div class="form-group">
		                 		<label for="" class="col-sm-2 col-sm-2 control-label">Otoritas</label>
							<div class="col-md-3 col-xs-11">
							...
							<div class="form-group">
		                  		<label for="" class="col-sm-2 col-sm-2 control-label"></label>
									<div class="col-sm-10">
								<button type="submit" class="btn btn-theme03 fontstyle">Update</button>
									</div>
		                </div>
		                </div>
		                </div>
