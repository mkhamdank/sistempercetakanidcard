			...
			<div class="row mt">
	          <div class="col-lg-12">
	            <div class="form-panel">
	              	...
	              	<?php echo form_open_multipart('Reg_num/update/'.$this->uri->segment(3), $attributes); ?>
		                	...
		                	<div class="form-group">
			                 <label for="" class="col-sm-2 col-sm-2 control-label">Registration Number</label>
								<div class="col-md-3 col-xs-11">
									<input type="text" class="form-control" name="reg_number" placeholder="Masukkan Registration Number" required value="<?php echo $key->reg_number ?>">
								</div>
			                </div>
		                <?php } ?>
						<div class="form-group">
