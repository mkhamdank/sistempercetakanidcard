	...
	<body>
	    ...
	    <section id="main-content">
	      <section class="wrapper">
	      	 <h3 class="fontstyle"><i class="fa fa-angle-right"></i> Edit Data Personil</h3>
	        <div class="row mt">
	          <div class="col-lg-12">
	            <div class="form-panel">
	              
	              	<?php $attributes = array('class' =>"form-horizontal style-form"); ?>
	              	<?php echo form_open_multipart('Person/update/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5),$attributes); ?>
	              	<?php echo validation_errors(); ?>
						<?php if (ISSET($error)): ?>
							<?php echo $error ?>
						<?php endif ?>
		                <div class="form-group">
		                 <label for="" class="col-sm-2 col-sm-2 control-label">Nama Lengkap</label>
							<div class="col-md-3 col-xs-11">
								<input style="width: 220px;" type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Kontraktor" value="<?php echo $person[0]->nama ?>" required>
							</div>
		                </div>
		                <div class="form-group">
		                  <label for="" class="col-sm-2 col-sm-2 control-label">Foto Diri</label>
							 <div class="col-md-3 col-xs-11">
								<img width="50" src="<?=base_url("assets/uploads")."/".$person[0]->foto_diri?>">
									<input style="width: 220px" type="file" class="form-control" id="foto_diri" name="foto_diri" placeholder="" value="<?php 
									echo $person[0]->foto_diri ?>"onchange="readURL(this);">
									<img width="150px" id="blah" src="" style="display: none" alt="your image" />
							 </div> 
		                  </div>
		                <div class="form-group">
		                  <label for="" class="col-sm-2 col-sm-2 control-label">Foto KTP</label>
							<div class="col-md-3 col-xs-11">
								<img width="50" src="<?=base_url("assets/uploads")."/".$person[0]->foto_ktp?>">
									<input style="width: 220px" type="file" class="form-control" id="foto_ktp" name="foto_ktp" placeholder="" value="<?php 
									echo $person[0]->foto_ktp ?>"onchange="readURL2(this);">
									<img id="blah2" width="150px" src="" style="display: none" alt="your image" />
							</div>
		                </div>
		                <div class="form-group">
			                 <label for="" class="col-sm-2 col-sm-2 control-label">Alamat</label>
								<div class="col-md-3 col-xs-11">
									<input style="width: 220px" type="text" name="address" id="address" class="form-control" value="<?php echo $person[0]->address ?>" title="" required>
								</div>
		                </div>
		                <div class="form-group">
		                 		<label for="" class="col-sm-2 col-sm-2 control-label">Nomor Registrasi</label>
							<div class="col-md-3 col-xs-11">
								<input style="width: 220px" type="text" class="form-control" id="reg_num" name="reg_num" placeholder="" value="<?php 
									echo $person[0]->reg_num ?>" required>
							</div>
		                </div>
						<div class="form-group">
